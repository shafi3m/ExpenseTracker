...
## 🚀 Features
#### Expense Tracking: 
Add, view, and track your expenses with a total expense summary.

#### Dark Mode: 
Toggle between light and dark mode for better user experience.

#### Live Date Display: 
The app shows the current date at the top of the interface.

#### Clear All Expenses: 
Easily reset your list of expenses with one click.

#### Local Storage: 
Automatically saves your expenses in the browser's local storage, allowing you to persist data even after refreshing the page.
